...
/**
 * REST controller for managing {@link ke.natujenge.alumni.portal.domain.Project}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Project> partialUpdateProject(
        ...
        Optional<Project> result = projectRepository
            ...
            .map(existingProject -> {
                ...
                if (project.getNoOfPledgeReminder() != null) {
                    existingProject.setNoOfPledgeReminder(project.getNoOfPledgeReminder());
                }
                if (project.getContributedAmount() != null) {
                    existingProject.setContributedAmount(project.getContributedAmount());
                }
                if (project.getPaybill() != null) {
                    existingProject.setPaybill(project.getPaybill());
                }
                if (project.getConfigs() != null) {
                    existingProject.setConfigs(project.getConfigs());
                }
                ...
                if (project.getLastUpdatedOn() != null) {
                    existingProject.setLastUpdatedOn(project.getLastUpdatedOn());
                }
                if (project.getLastUpdatedBy() != null) {
                    existingProject.setLastUpdatedBy(project.getLastUpdatedBy());
                }
