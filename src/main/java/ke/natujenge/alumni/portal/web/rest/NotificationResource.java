...
/**
 * REST controller for managing {@link ke.natujenge.alumni.portal.domain.Notification}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Notification> partialUpdateNotification(
        ...
        Optional<Notification> result = notificationRepository
            ...
            .map(existingNotification -> {
                ...
                if (notification.getLastUpdatedOn() != null) {
                    existingNotification.setLastUpdatedOn(notification.getLastUpdatedOn());
                }
                if (notification.getLastUpdatedBy() != null) {
                    existingNotification.setLastUpdatedBy(notification.getLastUpdatedBy());
                }
